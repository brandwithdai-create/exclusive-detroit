// Vercel serverless function — Detroit arts & theatre via Ticketmaster
// Path: /api/events/theatre
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (!tmRes.ok) {
      ...
      console.error(`[ExclusiveDetroit] Ticketmaster theatre HTTP ${tmRes.status}:`, text.slice(0, 200));
    ...
    console.error("[ExclusiveDetroit] theatre fetch error:", err.message);
