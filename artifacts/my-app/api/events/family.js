// Vercel serverless function — Detroit family events via Ticketmaster
// Path: /api/events/family
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (!tmRes.ok) {
      ...
      console.error(`[ExclusiveDetroit] Ticketmaster family HTTP ${tmRes.status}:`, text.slice(0, 200));
    ...
    console.error("[ExclusiveDetroit] family fetch error:", err.message);
