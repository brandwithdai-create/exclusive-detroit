...
export const HOTELS = [
  ...
  {
    id: "hotel-6",
    name: "Graduate Detroit",
    hood: "Midtown",
    addr: "3600 Woodward Ave",
    desc: "Adjacent to Wayne State University and the Detroit Institute of Arts, Graduate Detroit channels the city's creative spirit through locally inspired design, a rooftop bar, and museum-district energy.",
    price_from: "From $139/night",
    features: ["Midtown", "Rooftop Bar", "Arts District"],
    image: "/hotels/graduate.jpg",
    images: [],
    booking_url: "https://www.booking.com/hotel/us/graduate-detroit.html",
    affiliate_booking_url: null,
    website_url: "https://www.graduatehotels.com/detroit/",
  },
  {
    id: "hotel-7",
    name: "Canopy by Hilton Detroit Downtown",
    hood: "Downtown",
    addr: "1 Washington Blvd",
    desc: "A fresh take on downtown Detroit hospitality — bright, modern rooms, locally sourced breakfast, and a position at the intersection of the city's best entertainment and dining.",
    price_from: "From $159/night",
    features: ["Downtown", "Modern Design", "Hilton Brand"],
    image: "/hotels/canopy.jpg",
    images: [],
    booking_url: "https://www.booking.com/hotel/us/canopy-by-hilton-detroit-downtown.html",
    affiliate_booking_url: null,
    website_url: "https://www.hilton.com/en/hotels/dtwcnpy-canopy-detroit-downtown/",
  },
];
