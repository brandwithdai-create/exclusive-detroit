...
export default function Stay({ isSavedHotel, toggleSavedHotel, onBack }) {
  ...
  return (
    <div>
      <div style={{ background:C.deep, padding:"10px 22px 10px", borderBottom:"1px solid "+C.border }}>
        <div style={{ maxWidth:1200, margin:"0 auto" }}>
          ...
          <p style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"0.76rem", color:C.ash, fontWeight:300, lineHeight:1.5, margin:0, maxWidth:560 }}>
