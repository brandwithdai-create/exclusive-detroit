...
React.createElement("div",{style:{display:"flex",gap:10,justifyContent:"center",marginTop:"var(--hero-acts-mt)",flexWrap:"wrap"}},
...
React.createElement("div",{style:{background:C.card,border:"1px solid "+C.border,borderRadius:16,padding:"20px 22px 18px",textAlign:"center",display:"flex",flexDirection:"column",alignItems:"center"}},
React.createElement("div",{style:{width:100,height:100,borderRadius:"50%",border:"2px solid "+C.gold,overflow:"hidden",marginBottom:10,flexShrink:0,boxShadow:"0 0 0 4px var(--c-excl-bg)"}},
...
React.createElement("p",{style:{fontFamily:"'DM Mono',monospace",fontSize:"0.48rem",letterSpacing:"0.22em",textTransform:"uppercase",color:C.goldL,margin:"0 0 5px"}},"Creator & Founder"),
React.createElement("h3",{style:{fontFamily:"'Cormorant Garamond',serif",fontSize:"1.65rem",fontWeight:400,color:C.white,margin:"0 0 10px",lineHeight:1.15}},"Hi, I'm Dai"),
React.createElement("p",{style:{fontSize:"0.88rem",color:C.ash,fontWeight:300,lineHeight:1.75,margin:"0 0 12px",maxWidth:"100%"}},"Born and raised in Detroit, I\u2019ve explored this city from top to bottom. Every recommendation here is personal, current, and intentionally chosen \u2014 places I\u2019ve experienced, trust, and return to."),
React.createElement("p",{style:{fontFamily:"'Cormorant Garamond',serif",fontStyle:"italic",fontSize:"1.05rem",color:C.gold,lineHeight:1.45,margin:"0 0 12px",maxWidth:"100%"}},"\u201cIf you know, you know\u2026 & if you don\u2019t, now you do.\u201d"),
React.createElement("p",{style:{fontFamily:"'DM Mono',monospace",fontSize:"0.45rem",letterSpacing:"0.14em",textTransform:"uppercase",color:C.ash,opacity:0.6,margin:"0 0 8px"}},"Follow for hidden gems in every city"),
React.createElement("a",{href:"https://www.instagram.com/the_lovelydai?igsh=Zmh1OHZrYzBhZmI1&utm_source=qr",target:"_blank",rel:"noopener noreferrer",className:"creator-cta",style:{display:"inline-flex",alignItems:"center",gap:8,padding:"10px 22px",borderRadius:100,border:"1.5px solid "+C.border,background:"var(--c-excl-bg)",color:C.ash,textDecoration:"none",cursor:"pointer",transition:"border-color 0.2s,color 0.2s,background 0.2s"}},
...
React.createElement("span",{style:{fontFamily:"'DM Mono',monospace",fontSize:"0.56rem",letterSpacing:"0.08em"}},"@the_lovelydai")
)
)
),
