...
React.createElement("div",{style:{position:"absolute",top:0,left:0,right:0,height:"58%",background:"var(--c-card-top-fade)",pointerEvents:"none",zIndex:1}}),
React.createElement("span",{style:{position:"absolute",top:"50%",left:0,right:0,transform:"translateY(-50%)",textAlign:"center",fontFamily:"'DM Mono',monospace",fontSize:"0.52rem",letterSpacing:"0.14em",textTransform:"uppercase",color:"#fff",fontWeight:600,lineHeight:1.4,padding:"0 4px",display:"block",whiteSpace:"pre-line",textShadow:"0 1px 6px rgba(0,0,0,0.72)",zIndex:2}},label)
)
)
)
)
