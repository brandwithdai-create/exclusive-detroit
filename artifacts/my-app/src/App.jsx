...
React.createElement("div", { style:{ background:just?"rgba(var(--c-gold-rgb),0.09)":"rgba(110,75,195,0.09)", border:"1px solid "+(just?"rgba(var(--c-gold-rgb),0.28)":"rgba(110,75,195,0.28)"), borderRadius:5, padding:"6px 10px" }},
