...
cats:["Hidden Bars","Alley Spots"],badges:["hidden","locals"], tags:["calm","elevated","drinks","dateNight"], websiteUrl:"https://www.badluckbar.com" },
...
badges:["locals","hidden"], tags:["calm","drinks","dateNight"], websiteUrl:"https://www.timewilltelldet.com" },
...
image:"/venue-photos/94.jpg", badges:["locals"], tags:["elevated","drinks","dateNight","lateNight"],
...
badges:["firsttimer","hidden"], tags:["elevated","drinks","dateNight"],
...
cats:["Cocktail Lounges","Alley Spots"],badges:["firsttimer","locals"], tags:["elevated","drinks","dateNight","lateNight"], reservationUrl:"https://www.opentable.com/r/standby-detroit" },
...
image:"/venue-photos/95.jpg", badges:["firsttimer","locals"], tags:["elevated","drinks","dateNight"],
...
cats:["Hidden Bars","Cocktail Lounges"],badges:["hidden","locals"], tags:["calm","elevated","drinks","dateNight"], reservationUrl:"https://www.opentable.com/r/shelby-detroit" },
...
badges:["firsttimer"], cats:[], tags:["elevated","drinks","dateNight"], reservationUrl:"https://www.opentable.com/r/the-monarch-club-detroit" },
...
badges:["firsttimer"], tags:["elevated","drinks","groupFriendly"], reservationUrl:"https://www.exploretock.com/godfrey-detroit" },
...
badges:["firsttimer","locals"], tags:["elevated","drinks","dateNight"], reservationUrl:"https://resy.com/cities/detroit-mi/venues/kampers" },
...
badges:["hidden","locals"], tags:["calm","elevated","drinks","dateNight"], reservationUrl:"https://www.opentable.com/r/the-monarch-club-detroit" },
...
badges:["firsttimer"], tags:["highEnergy","chill","drinks","groupFriendly","lateNight"], websiteUrl:"https://tinroofdetroit.com/" },
...
cats:["Dinner"],badges:["firsttimer"], tags:["elevated","food","dateNight"], reservationUrl:"https://www.opentable.com/r/parc-detroit" },
...
tags:["elevated","food","dateNight"], reservationUrl:"https://resy.com/cities/detroit-mi/venues/prime_and_proper" },
...
cats:["Dinner"],badges:["firsttimer"],
tags:["elevated","food","dateNight"], reservationUrl:"https://www.opentable.com/r/besa-detroit" },
...
tags:["elevated","food","dateNight"], reservationUrl:"https://www.opentable.com/r/ostrea-detroit" },
...
cats:["Dinner"],badges:["firsttimer","locals"],
tags:["elevated","food","dateNight"], reservationUrl:"https://www.opentable.com/r/barda-detroit" },
...
cats:["Dinner"],badges:["firsttimer","locals"],
tags:["elevated","food","dateNight"], reservationUrl:"https://www.opentable.com/r/selden-standard-detroit" },
...
cats:["Dinner"],badges:["firsttimer","locals"],
tags:["elevated","food","dateNight"], reservationUrl:"https://resy.com/cities/detroit-mi/venues/hiroki-san" },
...
cats:["Dinner"],badges:["firsttimer"],
tags:["elevated","food","dateNight"], reservationUrl:"https://resy.com/cities/detroit-mi/venues/le-supreme" },
...
badges:["hidden","locals"], tags:["calm","elevated","drinks","dateNight"],
...
badges:["firsttimer","locals"], cats:["Cocktail Lounges"], tags:["elevated","food","drinks","dateNight"],
...
badges:["locals","firsttimer"],
cuisine:"Italian / Mediterranean",priceRange:"$$$$",reservations:"Recommended",
...
cats:["Dinner"], badges:["firsttimer"], tags:["elevated","food","dateNight"],
...
badges:["firsttimer","locals"],
tags:["elevated","food","dateNight","groupFriendly"], reservationUrl:"https://resy.com/cities/detroit-mi/venues/leila" },
...
badges:["firsttimer","locals"],
tags:["elevated","food","dateNight"], reservationUrl:"https://www.opentable.com/r/san-morello-detroit" },
...
badges:["locals"], tags:["chill","food","happyHour"],
...
badges:["locals","firsttimer"],
tags:["chill","food","drinks","lateNight"], reservationUrl:"https://www.opentable.com/r/bakersfield-detroit-2" },
...
badges:["locals","firsttimer"], tags:["chill","food","happyHour"],
...
badges:["locals"], tags:["chill","food","drinks","groupFriendly"],
...
badges:["firsttimer"], tags:["elevated","food","dateNight"],
...
React.createElement("span", { style:{ fontFamily:"'DM Mono',monospace", fontSize:"0.38rem", letterSpacing:"0.18em", color:"rgba(var(--c-gold-rgb),0.38)", textTransform:"uppercase" } }, "Detroit")
)
);
});
...
React.createElement("div",{style:{padding:"10px 12px 14px",display:"flex",gap:8,alignItems:"center"}},
  ...
  React.createElement("button",{
    ...
    style:{width:42,height:42,flexShrink:0,borderRadius:"50%",background:isVis?"rgba(201,168,76,0.10)":"rgba(201,168,76,0.07)",border:isVis?"2px solid rgba(201,168,76,0.88)":"1.5px solid rgba(201,168,76,0.48)",boxShadow:isVis?"0 0 0 3px rgba(201,168,76,0.18),0 0 12px rgba(201,168,76,0.52)":"none",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",transition:"background 0.25s ease,border-color 0.25s ease,box-shadow 0.25s ease",transform:pressing?"scale(0.86)":"scale(1)",animation:stampPop?"passportStamp 0.75s cubic-bezier(0.34,1.56,0.64,1) both":"none"}
  },
    React.createElement(PassportOutlineSVG,{stroke:isVis?"rgba(201,168,76,0.95)":C.goldD,size:20})
  )
)
);
});
...
function Modal({ venue, isFav, onFav, onClose, photoMap, galleryMap, isVis=false, onVisit, visitedDate }) {
...
return React.createElement(React.Fragment,null,
  ...
  React.createElement("div",{style:{position:"fixed",top:"50%",left:"50%",transform:"translate(-50%,-50%)",width:"min(620px,93vw)",maxHeight:"92vh",overflowY:"auto",WebkitOverflowScrolling:"touch",overscrollBehavior:"contain",background:"var(--c-modal-bg)",border:"1px solid var(--c-modal-bdr)",borderRadius:20,zIndex:900}},
    ...
    React.createElement("div",{style:{padding:"20px 20px 32px",display:"flex",flexDirection:"column",gap:16}},
      ...
      galleryPhotos&&galleryPhotos.length>0&&React.createElement("div",{style:{display:"flex",flexDirection:"column",gap:9}},
...
const mHtml=isNew
  ?`<div style="width:11px;height:11px;background:${pin};border-radius:50%;border:1.5px solid rgba(255,255,255,0.60);box-shadow:0 0 0 2px rgba(200,174,255,0.16),0 0 5px rgba(200,174,255,0.32);cursor:pointer"></div>`
  :`<div style="width:11px;height:11px;background:#C9A84C;border-radius:50%;border:1.5px solid rgba(255,240,170,0.70);box-shadow:0 0 0 2px rgba(201,168,76,0.16),0 0 5px rgba(201,168,76,0.36);cursor:pointer"></div>`;
const icon=L.divIcon({className:"",html:mHtml,iconSize:[11,11],iconAnchor:[5,5]});
...
React.useEffect(()=>{
if(selectedMarkerRef.current){const{marker:m,pin}=selectedMarkerRef.current;const isNewPin=pin==="#C8AEFF";const restoreHtml=isNewPin?`<div style="width:11px;height:11px;background:#C8AEFF;border-radius:50%;border:1.5px solid rgba(255,255,255,0.60);box-shadow:0 0 0 2px rgba(200,174,255,0.16),0 0 5px rgba(200,174,255,0.32);cursor:pointer"></div>`:`<div style="width:11px;height:11px;background:#C9A84C;border-radius:50%;border:1.5px solid rgba(255,240,170,0.70);box-shadow:0 0 0 2px rgba(201,168,76,0.16),0 0 5px rgba(201,168,76,0.36);cursor:pointer"></div>`;m.setIcon(L.divIcon({className:"",html:restoreHtml,iconSize:[11,11],iconAnchor:[5,5]}));selectedMarkerRef.current=null;}
const activeId=selected?String(selected.id):hotelDetail?String(hotelDetail.id):null;
if(activeId){const entry=markersRef.current.get(activeId);if(entry){const{marker:m,pin}=entry;const isNewPin=pin==="#C8AEFF";const selBg=isNewPin?"#C8AEFF":"#C9A84C";const selGlow=isNewPin?"0 0 0 3px rgba(200,174,255,0.18),0 0 8px rgba(200,174,255,0.44),0 2px 6px rgba(0,0,0,0.36)":"0 0 0 3px rgba(201,168,76,0.18),0 0 8px rgba(201,168,76,0.50),0 2px 6px rgba(0,0,0,0.36)";const selBdr=isNewPin?"rgba(255,255,255,0.85)":"rgba(255,240,160,0.88)";m.setIcon(L.divIcon({className:"",html:`<div style="width:18px;height:18px;background:${selBg};border-radius:50%;border:2px solid ${selBdr};box-shadow:${selGlow};display:flex;align-items:center;justify-content:center;font-size:8px;color:rgba(10,8,4,0.90)">★</div>`,iconSize:[18,18],iconAnchor:[9,9]}));selectedMarkerRef.current=entry;}}
...
React.createElement("button",{onClick:()=>toggleSavedHotel(String(hotelDetail.id)),title:hdSv?"Saved":"Save",style:{flex:"0 0 auto",width:38,height:38,display:"inline-flex",alignItems:"center",justifyContent:"center",padding:0,background:hdSv?"rgba(var(--c-gold-rgb),0.15)":"var(--c-sheet-save-bg)",border:"1.5px solid "+(hdSv?"rgba(var(--c-gold-rgb),0.7)":"var(--c-sheet-save-bdr)"),color:hdSv?C.gold:"var(--c-modal-save-clr)",fontSize:"1rem",borderRadius:8,cursor:"pointer",transition:"all 0.18s"}},hdSv?"\u2665":"\u2661")
)
)
);
...
return React.createElement("button",{key:v.id,onClick:()=>{setHotelDetail(null);setSelected(v);setShowList(false);},style:{width:"100%",display:"flex",alignItems:"center",gap:12,padding:"11px 16px",background:isSel?"rgba(var(--c-gold-rgb),0.08)":"none",border:"none",borderBottom:"1px solid var(--c-sheet-bdr)",cursor:"pointer",textAlign:"left",touchAction:"manipulation"}},
...
React.createElement("button",{onClick:()=>{setShowSavedOnly(s=>!s);setSelected(null);setHotelDetail(null);},title:showSavedOnly?"Show all venues":"Show saved only",style:{...CTRL,width:40,height:40,borderRadius:10,boxShadow:"0 4px 22px rgba(0,0,0,0.32)",border:"1px solid "+(showSavedOnly?C.gold:"var(--c-mzoom-bdr)"),background:showSavedOnly?"rgba(var(--c-gold-rgb),0.18)":"var(--c-mzoom-bg)",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.2s",touchAction:"manipulation"}},
...
!mapHotelModal&&React.createElement("button",{onClick:()=>setShowList(s=>!s),style:{...PILL,position:"absolute",bottom:"calc(18px + env(safe-area-inset-bottom))",left:14,zIndex:900,touchAction:"manipulation",border:showList?"1px solid "+C.gold:"1px solid var(--c-mzoom-bdr)",color:showList?C.gold:"var(--c-mzoom-color)"}},"≡  List"),
...
React.createElement("div",{style:{width:7,height:7,borderRadius:"50%",background:C.gold,boxShadow:"0 0 6px rgba(var(--c-gold-rgb),0.55)",flexShrink:0}}),
...
selectedPinPos&&selected&&React.createElement("div",{onClick:()=>{if(selected.cat==="Hotels"){const fh=HOTELS.find(h=>String(h.id)===String(selected.id));setMapHotelModal(fh||selected);setSelected(null);}else{setModalId(String(selected.id));setSelected(null);}},style:{position:"absolute",left:pinCardL,top:pinCardT,width:PIN_CARD_W,background:"rgba(10,8,6,0.96)",backdropFilter:"blur(14px)",WebkitBackdropFilter:"blur(14px)",border:"1px solid rgba(var(--c-gold-rgb),0.22)",borderRadius:14,zIndex:1100,overflow:"hidden",boxShadow:"0 14px 44px rgba(0,0,0,0.72),0 2px 10px rgba(0,0,0,0.4)",display:"flex",flexDirection:"row",animation:"cardPopIn 0.22s cubic-bezier(0.32,0.72,0,1) both",touchAction:"manipulation",cursor:"pointer"}},
...
const [savedDetailHotel,setSavedDetailHotel]=useState(null);
const [savedDetailEvt,  setSavedDetailEvt]  =useState(null);
...
useEffect(()=>{fetch('/api/places/venue-gallery').then(r=>r.ok?r.json():null).then(d=>{if(d?.gallery)setGalleryMap(d.gallery);}).catch(()=>{});},[]);
useEffect(()=>{
...
let t1,t2;
const run=()=>{
const el=document.querySelector('.creator-highlight');
if(!el)return;
el.classList.remove('glow','fade');
void el.offsetWidth;
el.classList.add('glow');
t1=setTimeout(()=>{el.classList.add('fade');},1500);
t2=setTimeout(()=>{el.classList.remove('glow','fade');},2700);
};
...
const savePlan=useCallback(plan=>{const key=(plan.stops||[]).map(v=>String(v.id)).sort().join(",");setSavedPlans(prev=>{if(prev.some(p=>(p.stops||[]).map(v=>String(v.id)).sort().join(",")===key))return prev;return [{...plan,id:Date.now()+"p",savedAt:new Date().toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})},...prev.slice(0,19)];});},[]); 
...
React.createElement("h1",{style:{fontFamily:"'Cormorant Garamond',serif",fontSize:"clamp(2.8rem,7vw,5.5rem)",fontWeight:400,lineHeight:0.92,color:C.white,marginBottom:20,textShadow:"var(--hero-title-shadow)"}},
"Detroit",React.createElement("br"),React.createElement("em",{style:{fontStyle:"italic",color:"var(--c-hero-gold,"+C.goldL+")",textShadow:"var(--c-hero-gem-shadow,none)"}},"Hidden Gems")
),
React.createElement("p",{style:{fontSize:"0.9rem",fontWeight:500,color:"var(--c-hero-sub)",maxWidth:480,margin:"0 auto 26px",lineHeight:1.82}},"The insider's guide to Detroit's most exclusive dining, cocktails, experiences, and hidden gems. Not for everyone — made for you."),
...
React.createElement("button",{key:c,onClick:()=>goCategory(c),style:{fontFamily:"'DM Mono',monospace",fontSize:"0.52rem",letterSpacing:"0.11em",textTransform:"uppercase",border:"var(--c-hero-pill-bdr,1.5px solid var(--c-hero-gold,"+C.gold+"))",color:cat===c?C.black:"var(--c-hero-goldL,"+C.goldL+")",background:cat===c?"var(--c-hero-gold,"+C.gold+")":"var(--c-hero-pill-bg)",backdropFilter:cat===c?"none":"var(--c-hero-btn-blur)",WebkitBackdropFilter:cat===c?"none":"var(--c-hero-btn-blur)",boxShadow:cat===c?"none":"var(--c-hero-btn-shadow)",padding:"7px var(--hero-pill-px)",borderRadius:100,cursor:"pointer",transition:"all 0.18s"}},c)
)
),
React.createElement("div",{style:{display:"flex",gap:10,justifyContent:"center"}},
...
React.createElement("div",{style:{display:"flex",gap:10,justifyContent:"center",marginTop:"var(--hero-purple-mt)",flexWrap:"wrap"}},
...
React.createElement("div",{style:{display:"flex",alignItems:"center",width:"100%",maxWidth:460,padding:"0 20px",boxSizing:"border-box",alignSelf:"center",marginTop:"var(--hero-acts-mt)"}},
React.createElement("div",{style:{flex:1,height:1,background:"linear-gradient(to left,rgba(var(--c-gold-rgb),0.42),rgba(var(--c-gold-rgb),0.04))"}}),
React.createElement("span",{style:{color:"rgba(var(--c-gold-rgb),0.68)",fontSize:"0.42rem",lineHeight:1,padding:"0 10px",display:"block",flexShrink:0}},"◆"),
React.createElement("div",{style:{flex:1,height:1,background:"linear-gradient(to right,rgba(var(--c-gold-rgb),0.42),rgba(var(--c-gold-rgb),0.04))"}})
),
...
{k:"hotels",label:"Hotel\nStays",img:(theme==="dark"||(theme==="system"&&window.matchMedia?.("(prefers-color-scheme:dark)")?.matches===true))?"/hero-cards/hotels.jpg":"/hero-cards/hotels-light.jpg",fn:()=>navTo("stay")},
{k:"events",label:"Events",img:(theme==="dark"||(theme==="system"&&window.matchMedia?.("(prefers-color-scheme:dark)")?.matches===true))?"/hero-cards/events.jpg":"/hero-cards/events-light.jpg",fn:()=>{setDoTab("events");navTo("things-to-do");}},
].map(({k,label,img,fn})=>
React.createElement("button",{key:k,onClick:fn,style:{flex:1,position:"relative",height:152,borderRadius:14,overflow:"hidden",border:"var(--c-hero-act-card-bdr,1.5px solid rgba(var(--c-gold-rgb),0.20))",padding:0,cursor:"pointer",backgroundImage:`url(${img})`,backgroundSize:"cover",backgroundPosition:"center",backgroundColor:"#0a0808",boxShadow:"0 6px 24px rgba(0,0,0,0.55)",touchAction:"manipulation",willChange:"transform",transform:"translateZ(0)",isolation:"isolate"}},
...
React.createElement("div",{style:{background:C.deep,border:"1px solid rgba(var(--c-gold-rgb),0.28)",borderRadius:22,padding:"44px 32px 36px",maxWidth:360,width:"100%",textAlign:"center",position:"relative",boxShadow:"0 32px 80px rgba(0,0,0,0.7)"},onClick:e=>e.stopPropagation()},
React.createElement("div",{style:{width:44,height:44,borderRadius:"50%",border:"1px solid rgba(var(--c-gold-rgb),0.35)",display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 22px",color:C.gold,fontSize:"1.1rem"}},"◎"),
...
React.createElement("div",{style:{flex:1,height:1,background:"rgba(var(--c-gold-rgb),0.18)"}})
);
...
React.createElement("h2",{style:{fontFamily:"'Cormorant Garamond',serif",fontSize:"clamp(1.6rem,4vw,2.4rem)",fontWeight:400,color:C.white,margin:"0 0 4px"}},"Detroit Neighborhoods"),
React.createElement("p",{style:{fontSize:"0.82rem",color:C.smoke,margin:0}},"Each pocket of the city has its own energy.")
)
),
React.createElement("div",{style:{maxWidth:1200,margin:"0 auto",padding:"24px 22px 56px"}},
...
React.createElement("div",{className:"creator-highlight",style:{maxWidth:700,margin:"0 auto",padding:"32px 22px 0"}},
...
React.createElement("h3",{style:{fontFamily:"'Cormorant Garamond',serif",fontSize:"1.25rem",fontWeight:400,color:C.white,marginBottom:10}},t),
React.createElement("p",{style:{fontSize:"0.88rem",color:C.ash,fontWeight:300,lineHeight:1.85}},b)
)),
React.createElement("div",null,
React.createElement("h3",{style:{fontFamily:"'Cormorant Garamond',serif",fontSize:"1.25rem",fontWeight:400,color:C.white,marginBottom:13}},"Traveler Tips"),
React.createElement("div",{style:{display:"flex",flexDirection:"column",gap:10}},
...
return React.createElement("button",{key:val,onClick:function(){setTheme(val);},style:{fontFamily:"'DM Mono',monospace",fontSize:"0.52rem",letterSpacing:"0.12em",textTransform:"uppercase",padding:"9px 18px",borderRadius:100,border:"1px solid "+(theme===val?C.gold:C.border),background:theme===val?"rgba(var(--c-gold-rgb),0.12)":"transparent",color:theme===val?C.gold:C.smoke,cursor:"pointer",transition:"all 0.2s"}},lbl);
})
)
)
)),
...
React.createElement("div",{style:{display:"flex",gap:8,flexWrap:"wrap"}},
React.createElement("button",{onClick:function(){setShowOnboarding(true);},style:{fontFamily:"'DM Mono',monospace",fontSize:"0.52rem",letterSpacing:"0.12em",textTransform:"uppercase",padding:"10px 22px",borderRadius:100,border:"1px solid var(--c-goldD)",background:"rgba(var(--c-gold-rgb),0.08)",color:C.gold,cursor:"pointer",transition:"all 0.2s"}},"View App Tour"),
...
BottomNav(),
GeoModal(),
modalId!==null&&React.createElement(Modal,{venue:modalVenue,isFav:isFav(modalId),onFav:toggleFav,onClose:()=>setModalId(null),photoMap,galleryMap,isVis:isVisited(modalId),onVisit:toggleVisited,visitedDate:getVisitedDate(String(modalId))}),
