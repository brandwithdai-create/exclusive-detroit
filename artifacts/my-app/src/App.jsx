...
React.createElement("div",{style:{position:"absolute",inset:0,backgroundImage:"url(/detroit-skyline.jpg)",backgroundSize:"cover",backgroundPosition:"center 40%",opacity:"var(--c-hero-img-opacity)",filter:"brightness(1.22) saturate(1.18) contrast(1.04)",pointerEvents:"none",willChange:"transform",transform:"translateZ(0)"}}),
